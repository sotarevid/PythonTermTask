...
def main(date=None, weekends=None, staf=None):
    """
    ...
    if staf is None:
        staf = [Staf('Dick', 'Big', 0.5, [(2, "ОТ"), (3, 'ОТ'), (4, "ОТ"), (25, "Б")]),
                Staf('Lol', 'kek', 1, [(2, "Б"), (5, 'ОТ'), (6, "ОТ"), (27, "Б")]),
                Staf('Yaga', 'Baba', 0.33, [(3, "ОТ"), (5, 'ОТ'), (9, "Б")]),
                Staf('Dad', 'Papa', 2, [(12, "Б"), (13, 'Б'), (28, "ОТ"), (29, "ОТ"), (30, 'ОТ')])]
    if weekends is None:
        weekends = [1, 2, 12, 13, 20, 21, 28, 31]
    data = [staf, weekends, date]
    write_data_to_file(data, weekends, ws)
    save_file(date, wb_template)
